...
from {{app_name}}.apps.accounts.models import User
from {{app_name}}.apps.accounts.serializer import UserSerializer, ChangePasswordSerializer
from {{app_name}}.apps.utils.error_factory import ErrorFactory, ErrorType
from {{app_name}}.permissions import IsCreationOrIsAuthenticated, NoPermissionNeeded
...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def lost_password(self, request):
        try:
            ...
            from {{app_name}}.apps.utils.recovery_password_rest import password_reset
